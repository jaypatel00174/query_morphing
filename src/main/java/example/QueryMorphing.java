...
public class QueryMorphing<V extends NumberVector> extends AbstractAlgorithm<Clustering<SubspaceModel>> implements SubspaceClusteringAlgorithm<SubspaceModel> {
	  
	  //The logger for this class.
	  private static final Logging LOG = Logging.getLogger(QueryMorphing.class);
	  ...
	  private boolean prune; 	// Holds the value of {@link #PRUNE_ID}.

	  public QueryMorphing(int xsi, double tau, boolean prune) {
	    super();
	    this.xsi = xsi;
	    this.tau = tau;
	    this.prune = prune;
	  ...
	  public static class Parameterizer<V extends NumberVector> extends AbstractParameterizer {
	    ...
	    @Override
	    protected QueryMorphing<V> makeInstance() {
	      return new QueryMorphing<V>(xsi, tau, prune);
	    }
	  }
	}
